...
Version 0.1
April 2022
Ligo Scientific Collaboration (LSC) & Noam Rimer
...
## mf_plots
# Matched Filtering to Find the Signal Plots
def mf_plots(fs,
			 template_p,
			 template_c,
			 time, 
...
###############################################################################
## templator
# This function was not (explicitly) described in the assignment prompt. 
# But is an effective way for me to successfully create both: an mf_plots() function, and keep the index.ipynb working!
